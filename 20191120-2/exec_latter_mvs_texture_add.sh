...
#texturemesh
${MVSBUILDMAIN}/TextureMesh ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/out/reconstruction_sequential/scene_dense_mesh.mvs --mesh-file ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/out/reconstruction_sequential/scene_dense_mesh_del.ply
...
cp -r ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/out /home/repos/install/install/${IMGDIRNAME}
