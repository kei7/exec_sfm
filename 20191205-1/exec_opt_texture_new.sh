...
do
  cp ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/opt/$line.jpg ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/images/OPTA000002.jpg
  cp ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/opt/$line.jpg ./undistorted_images/OPTA000002.jpg
