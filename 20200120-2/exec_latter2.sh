...
cat ./model3.py.in | sed -e "s#@OPENMVG_SOFTWARE_SFM_BUILD_DIR@#/home/repos/openMVG_build/Linux-x86_64-RELEASE#g" -e "s#@OPENMVG_SOFTWARE_SFM_SRC_DIR@#/home/repos/openMVG/src/software/SfM#g" -e "s#@IMGSRC@#${IMGDIRNAME}#g" > ./${MAKEMODEL_NAME}2.py
...
cp -r ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/out /home/repos/install/install/${IMGDIRNAME}/out_0120
