...
#cp -r ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/images ${MVSBUILDMAIN}/undistorted_images/${IMGDIRNAME}/images
...
#texturemesh
/home/repos/openMVS_build/bin/TextureMesh ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/out/reconstruction_sequential/scene_dense_mesh.mvs
...
#mkdir -p /home/repos/out/${TYPE}/${SHOTDATE}/${DATE}/${IMGDIRNAME}
#cp -r ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/out/* /home/repos/out/${TYPE}/${SHOTDATE}/${DATE}/${IMGDIRNAME}
cp -r ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/out /home/repos/install/install/${IMGDIRNAME}/out2_2
