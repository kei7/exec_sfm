...
#3dmorph image copy
#cp -r /home/repos/install/install/${IMGDIRNAME} ${MVGBUILDMAIN}/${MVGEXEC}/input/
...
#python ./chexif.py /home/repos/ ${IMGDIRNAME}

mkdir ${MVSBUILDMAIN}/undistorted_images
...
cp ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/images/* ./undistorted_images/
###################
######execute######
###################
...
#copy output
#mkdir ${IMGOUTPATH}/${SHOTDATE}/${DATE}/${IMGDIRNAME}
#cp -r ${MVGBUILDMAIN}/${MVGEXEC}/input/${IMGDIRNAME}/out/* ${IMGOUTPATH}/${SHOTDATE}/${DATE}/${IMGDIRNAME}
